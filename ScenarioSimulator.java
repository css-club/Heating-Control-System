...
class ScenarioSimulator {
    ...
    public void simulateScenario2() {
        ...
        room.setRoomTemp(18);
        // The user leaves the room before the Inside time elapses so the Target temperature does not change
        // Add output: Simulate scenario 2 logic and behavior.

    }

    public void simulateScenario3() {
        // The user leaves the room for a long time which causes system to activate
    ...
    public void simulateScenario5() {
        ...
        room.setTargetTemp(20);
        room.setRoomTemp(20);
        //The user is present and opens the window
        room.setPresenceSwitch(true);
        room.setWindow(true);
        room.setTargetTemp(room.getAwayTemp());
    ...
    public void simulateScenario11() {
        ...
        if (room.getRoomTemp() > room.getTargetTemp() + 1) {
            ...
            // Add output: Room temperature exceeds target. Heater turned off. window remains closed.
        }
    }
